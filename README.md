# India COVID 19 Live Update

This is a web application based on Python and JS.

### Prerequisites

I would recommend to use VS Code. 
Install 'Live Server' in VS Code from marketplace.

For running the Python code you can use any IDE of your choice.


## Running the Code

As the Python and Web code is not directly connected as of now, therefore first execute the Python code as this is the script that will scrap the data from the target website and update the JSON files.

Now use the Live Server in VS Code to run the index.html file.

## Authors

* **Chaitanya Joshi**

### Below is the information about the Bootstrap Layout Used.
